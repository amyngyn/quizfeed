...
<tr class="needBorder"><td colspan="3"><b>Score History</b></td></tr>
<tr>
<td class="wider">Quiz ID</td><td class="wider">Score</td><td class="wider">Total</td>
</tr>
<%for(int i=0; i<zIDs.size(); i++){ %>
<tr>
<td><%=zIDs.get(i)%></td><td><%=scores.get(i)%></td><td><%=possible.get(i)%></td>
</tr>
<%} %>
